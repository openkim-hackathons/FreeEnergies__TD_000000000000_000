...
def run_lammps(modelname: str, temperature_K: float, pressure_bar: float, timestep_ps: float,
               ...
               lammps_command: str, random_seed: int, output_dir: str, test_driver_dir: str) -> Tuple[str, str]:
    ...
    return log_filename, restart_filename