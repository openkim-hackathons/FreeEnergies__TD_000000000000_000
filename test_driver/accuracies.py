...
RELATIVE_ACCURACY: Sequence[Optional[float]] = [0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01]
ABSOLUTE_ACCURACY: Sequence[Optional[float]] = [None, None, None, None, None, None, None]